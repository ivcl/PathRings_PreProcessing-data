...
//                        object.linkIds = root.dbId + "." + object.dbId;
                ...
                $.ajax({
                    type: "GET",
                    url: "GallusEntrez2symbol.txt",    //GallusEntrez2symbol.txt    //gallus_gallus_ortholog.txt The column of those two files are different
                    dataType: "text",
                    success: function (txt) {
                        if(txt.length)
                        {
                            ...
                            for(var i=1; i<lines.length; ++i)
                            {
                                ...
                                var obj = {};
                                obj.symbol = arrays[1];
                                obj.dataBaseId = arrays[0];
                                gallusOrth.push(obj);
                            }

                            var file = new File(objects, root,gallusOrth);

                        }

//                        if(txt.length) //gallus_gallus_ortholog.txt
//                        {
//                            var gallusOrth = [];
//                            var lines = txt.split("\r\n");
//                            for(var i=1; i<lines.length; ++i)
